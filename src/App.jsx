        ...
        const filteredTodos = Object.entries(parsedTodos).reduce((acc, [date, tasks]) => {
          if (date >= today) {
            ...
            acc[date] = tasks.map(todo => ({
              ...todo,
              priority: PRIORITY_LEVELS[todo.priority] ? todo.priority : 'MEDIUM'
            }));
          }
          return acc;
        }, {});
  ...
  return (
    <div className='my-10 mx-2'>
      <Card className="w-full max-w-md mx-auto">
        {/* Rest of the JSX remains the same until the todo rendering */}
        <CardHeader>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-1 mt-1">
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded ${getPriorityStyle(todo.priority)}`}>
